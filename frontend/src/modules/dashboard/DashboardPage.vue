<template>
 ...
 <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
 <div class="min-w-0">
 <h2 class="text-lg font-bold text-txt-primary sm:text-xl">{{ t('dashboard.recent') }}</h2>
 <p class="mt-1 text-sm text-txt-muted">{{ t('dashboard.recentHint') }}</p>
 </div>
 ...
 :key="resume.id"
 class="group flex items-center justify-between rounded-xl border border-border p-4 transition hover:border-brand/40 hover:bg-brand/5"
 ...
 <div>
 <p class="font-semibold text-txt-primary group-hover:text-brand">{{ resume.title }}</p>
 <p class="text-xs text-txt-muted">{{ formatDate(resume.updated_at) }}</p>
 </div>
 </div>
 ...
 <div>
 <p class="text-xs font-bold uppercase tracking-wider text-txt-muted">Current Plan</p>
 <p class="text-lg font-bold text-txt-primary">{{ planLabel }}</p>
 </div>
 </div>
 <RouterLink class="rounded-lg bg-brand px-3 py-2 text-xs font-bold text-white shrink-0" to="/settings">Manage</RouterLink>
 </div>
 <p class="mt-3 flex items-center gap-2 text-sm text-txt-muted">
 ...
 <h2 class="text-xl font-bold text-txt-primary">{{ t('dashboard.quickActions') }}</h2>
 <p class="mt-1 text-sm text-txt-muted">{{ t('dashboard.quickActionsHint') }}</p>
 ...
 <RouterLink class="flex items-center gap-3 rounded-xl border border-border px-4 py-3 text-sm font-semibold text-txt-primary" to="/resumes">
 <svg class="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6h16M4 12h16M4 18h16" /></svg>
 {{ t('resumes.listing') }}
 </RouterLink>
 <RouterLink class="flex items-center gap-3 rounded-xl border border-border px-4 py-3 text-sm font-semibold text-txt-primary" to="/profile">
 ...
 <p class="text-xs font-semibold uppercase tracking-wider text-txt-muted">{{ t('dashboard.activity') }}</p>
 <div class="mt-3 h-16">
