<template>
 ...
 <div class="w-full max-w-md rounded-2xl bg-surface p-8 text-center shadow-xl shadow-slate-200/50">
 <div v-if="loading" class="flex flex-col items-center">
 <div class="size-12 animate-spin rounded-full border-4 border-border border-t-brand"></div>
 <p class="mt-4 text-txt-secondary font-medium">Verifying your email...</p>
 </div>
 ...
 <h2 class="text-2xl font-bold text-txt-primary">Email Verified!</h2>
 <p class="mt-2 text-txt-muted">Thank you for verifying your email address. You can now access all features of CareerAI.</p>
 ...
 <h2 class="text-2xl font-bold text-txt-primary">Verification Failed</h2>
 <p class="mt-2 text-txt-muted">{{ error || 'The link may have expired or is invalid.' }}</p>
 <RouterLink class="mt-6 inline-flex rounded-xl bg-brand px-6 py-3 font-semibold text-white transition hover:bg-brand/90" to="/dashboard">Go to Dashboard</RouterLink>
 </div>
 </div>
 </div>
