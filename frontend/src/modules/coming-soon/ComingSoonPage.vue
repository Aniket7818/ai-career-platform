<template>
 ...
 <RouterLink class="text-txt-muted hover:text-white" to="/">{{ t('nav.features') }}</RouterLink>
 <RouterLink class="text-txt-muted hover:text-white" to="/coming-soon">{{ t('nav.comingSoon') }}</RouterLink>
 <RouterLink class="rounded-md bg-brand px-4 py-2 font-semibold text-white" to="/login">{{ t('nav.login') }}</RouterLink>
 </nav>
 <button
 type="button"
 class="grid size-10 shrink-0 place-items-center rounded-xl border border-white/10 bg-surface/5 text-white transition hover:bg-surface/10 md:hidden"
 ...
 <RouterLink class="rounded-xl px-4 py-3 text-sm font-medium text-txt-muted transition hover:bg-surface/5 hover:text-white" to="/" @click="guestMenuOpen = false">{{ t('nav.features') }}</RouterLink>
 <RouterLink class="rounded-xl px-4 py-3 text-sm font-medium text-txt-muted transition hover:bg-surface/5 hover:text-white" to="/coming-soon" @click="guestMenuOpen = false">{{ t('nav.comingSoon') }}</RouterLink>
 ...
 <p class="mt-6 text-lg text-txt-disabled leading-relaxed">
 ...
 <div class="grid size-10 shrink-0 place-items-center rounded-full bg-surface/5 text-txt-muted">
 ...
 <p class="mt-3 text-sm leading-relaxed text-txt-disabled">{{ feature.description }}</p>
 </div>
 </div>
 </div>
 </section>
 ...
 <p class="text-txt-disabled text-sm max-w-2xl">{{ phase.description }}</p>
 </div>
 </div>
 </section>
 ...
 <p class="mt-4 text-lg text-txt-muted">Join our waitlist to get notified the moment our new AI features launch. No spam, just product updates.</p>
 <div class="mt-8">
 <button
 type="button"
...
const roadmap = [
 ...
 badgeColor: 'bg-background0/10 text-txt-muted border-slate-500/20',
 ...
 status: 'Future',
 color: 'bg-slate-700',
 badgeColor: 'bg-slate-700/30 text-txt-disabled border-border-hover/50',
