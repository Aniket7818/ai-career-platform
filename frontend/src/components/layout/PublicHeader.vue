<template>
 ...
 <a class="text-txt-secondary transition hover:text-txt-primary" href="/#features">{{ t('nav.features') }}</a>
 ...
 >
 <div v-if="isOpen" class="border-t border-border bg-surface px-5 py-4 shadow-lg md:hidden">
 <nav class="flex flex-col gap-1">
 <a class="block rounded-xl px-4 py-3 text-sm font-medium text-txt-secondary transition hover:bg-background" href="/#features" @click="close">{{ t('nav.features') }}</a>
