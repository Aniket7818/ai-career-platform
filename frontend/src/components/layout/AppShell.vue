<template>
 <div class="min-h-screen w-full bg-background lg:grid lg:h-screen lg:max-h-screen lg:grid-cols-[272px_minmax(0,1fr)] lg:overflow-hidden">
 <Transition
 ...
 <p class="text-[10px] font-semibold uppercase tracking-widest text-txt-disabled">{{ t('nav.workspace') }}</p>
 </div>
 </RouterLink>
 <button
 type="button"
 ...
 <p class="text-[10px] font-bold uppercase tracking-widest text-txt-muted">{{ t('nav.menu') }}</p>
 ...
 :class="isActive(item.to) ? 'bg-brand/20 text-white ring-1 ring-brand/30 shadow-glow' : 'text-txt-disabled hover:bg-surface/5 hover:text-white'"
 @click="close"
 >
...
const navItems = computed(() => [
 ...
 { to: '/interview-prep', icon: 'resumes', label: 'Interview Preparation' },
...
const pageTitle = computed(() => ({
 ...
 [ROUTE_NAMES.INTERVIEW_PREP]: 'Interview Preparation',
 [ROUTE_NAMES.INTERVIEW_PREP_SUBJECT]: 'Interview Preparation',
 [ROUTE_NAMES.INTERVIEW_PREP_QUESTION]: 'Interview Preparation',
